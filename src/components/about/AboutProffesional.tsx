const AboutProffesional: React.FC = () => {
  return (
    <div
      className="font-Fira bg-MainPrimary pl-3 pt-3 w-[100%] max-w-full
     h-full border-r border-NavBorderColor"
    >
...
export default AboutProffesional;
